    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    PostId = table.Column<Guid>(type: "TEXT", nullable: false),
                    TagSlug = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    TaggedByUserId = table.Column<Guid>(type: "TEXT", nullable: false),
                    TaggedAtUtc = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PostTags", x => new { x.PostId, x.TagSlug });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PostTags_Users_TaggedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Posts_LikeCount_Id",
                table: "Posts",
                columns: new[] { "LikeCount", "Id" },
                descending: new bool[0]);

            migrationBuilder.CreateIndex(
                name: "IX_PostTags_TaggedByUserId",
                table: "PostTags",
